...
// 미완성미완성미완성미완성미완성미완성미완성미완성미완성미완성미완성미완성미완성미완성미완성미완성
...
class Frame833 extends StatefulWidget {
  const Frame833({Key? key}) : super(key: key);

  @override
  State<Frame833> createState() => _Frame833State();
}

class _Frame833State extends State<Frame833> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
